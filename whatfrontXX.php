...
<div class="storebox">
 <?php
      ...
      $the_newer = get_posts('numberposts=17&category=130');
  	?>
     ...
     <?php if ( $counter == 10 ) { echo  "<br class='clearboth'><br>" ; } ?>
...
<font id='prodtitleF'><?php echo get_the_title($post); ?></font><br clear=right>



<font id='prodauthorF'>by <?php the_author_link(); ?></font><br clear=right>


<font id="prodtextF"><?php echo $only_post_text; ?></font><br clear=right>
...
<div id='prodbuttonF'><?php echo (do_shortcode("[eshop_addtocart]")); ?></div>
...
<a href="<?php echo get_permalink($post->post_parent); ?>#<?php echo the_ID(); ?>">
<font id="comictitlehome"><?php echo get_the_title($post); ?></font></a><br>
 

<font id='titleauthorhome'><I>by</I> <?php the_author(); ?><br>
...
<div id=homekeyline></div><br>
  ...
  <?php $counter++; ?>
	...
	if (!is_wp_error( $rss ) ) :
		$maxitems = $rss->get_item_quantity(17);
	...
	foreach ( $rss_items as $item ) : ?>
		...
		</a><br></font><div id=homekeyline></div><br>
		</div>
	<?php endforeach; ?>
